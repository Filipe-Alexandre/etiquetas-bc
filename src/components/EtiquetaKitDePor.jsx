    ...
    return (
        <div className="kit-wrapper">
            ...
            {Array.from({ length: Math.max(1, qtdTabelas) }).map((_, idx) => (
                <div className={`etiqueta kit depor-theme ${getTabelaClass(idx)}`} key={`tab-${idx}`} style={{ marginBottom: idx < Math.max(1, qtdTabelas) - 1 ? '20px' : '0' }}>
                    ...
                    <div className="kit-footer">
                        ...
                        <div className="kit-total-area depor-mode">
                            ...
                            <div className="total-por">
                                {/* TEXTO "POR APENAS" ALTERADO PARA "POR" */}
